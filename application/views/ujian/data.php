<div class="box">
    ...
    <div class="box-body">
        ...
        <div class="pull-right">
            <a href="<?= base_url('ujian/add') ?>" class="btn" style="background-color:#005555;color:white"><i class="fa fa-file-text-o"></i> Ujian Baru</a>
            <button type="button" onclick="reload_ajax()" class="btn btn-sm" style="background-color:#069A8E; color:white"><i class="fa fa-refresh"></i> Reload</button>
        </div>
    </div>
