<div class="callout callout-info">
    ...
    <p>1. Siswa wajib memiliki kartu peserta ujian (UNBK) dengan kode (03xxxxx) <br>
        2. Siswa wajib menyiapkan Handphone / laptop selama ujian berlangsung. <br>
        3. Siswa wajib memiliki email active dan email milik sendiri.<br>
        4. Siswa hanya akan diberi kesempatan log in satu kali, oleh karena itu siswa harus mengerjakan soal dengan teliti. jika ada kendala Harap hubungi team / panitia yang sudah ditugaskan melalui group kelas.<br>
        5. Durasi Mengerjakan soal perMapel 120 menit dan tidak ada penambahan waktu.</p>
</div>
