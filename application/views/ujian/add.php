<div class="box">
    ...
    <div class="box-body">
        <div class="row">
            <div class="col-sm-4">
                <div class="alert" style="background-color:#A1E3D8;">
                    <h4 class="text-white">Mata Pelajaran <i class="fa fa-book pull-right"></i></h4>
                    <p class="text-white"><?=$mapel->nama_mapel?></p>
                </div>
                <div class="alert" style="background-color:#A1E3D8;">
            ...
            <div class="col-sm-4">
                ...
                <div class="form-group pull-right">
                    ...
                    <button id="submit" type="submit" class="btn btn-flat" style="background-color:#A1E3D8;"><i class="fa fa-save"></i> Simpan</button>
                </div>
                <?=form_close()?>
            </div>
        </div>
