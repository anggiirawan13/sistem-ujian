...
class MYPDF extends TCPDF
{
    ...
    {
        $image_file = K_PATH_IMAGES . 'unnamed.jpg';
    ...
    public function Footer()
    {
        ...
        $this->Cell(0, 10, 'SMK BHARA TRIKORA 1 JAKARTA', 0, false, 'R', 0, '', 0, false, 'T', 'M');
    }
}
...
$pdf->SetAuthor('SMK Bhara Trikora 1 Jakarta');
...
$pdf->Output($ujian->nama_ujian . '_' . $mhs->nisn . '_' . $mhs->nama . '.pdf', 'I');
