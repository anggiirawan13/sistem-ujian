<div class="box">
    ...
    <div class="box-body">
		<div class="mt-2 mb-4">
			<button type="button" data-toggle="modal" data-target="#myModal" class="btn btn-sm" style="background-color:#069A8E;color:white"><i class="fa fa-plus"></i> Tambah </button>
            <a href="<?= base_url('jurusan/import') ?>" class="btn btn-sm" style="background-color:#005555;color:white" ><i class="fa fa-cloud-download"></i> Import</a>
