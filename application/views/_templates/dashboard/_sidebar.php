	...
	<section class="sidebar">
		...
		<div class="user-panel">
			<div class="pull-left image">
				...
				<?php else : ?>
					<img src="<?= base_url('uploads/profile/') .  $user->image ?>" class="img-circle" alt="User Image">
				<?php endif; ?>
			</div>
		...
		<ul class="sidebar-menu" data-widget="tree">
			...
			<li class="<?= $page === 'fotoprofile' ? "active" : "" ?>">
				<a href="<?= base_url('fotoprofile') ?>" rel="noopener noreferrer">
					<i class="fa fa-picture-o"></i> <span>Edit Foto Profile</span>
				</a>
			</li>
