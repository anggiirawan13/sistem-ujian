...
*/
$config['site_title']                 = "SMK Bhara Trikora 1";       // Site Title, example.com
$config['admin_email']                = "bhatrix.auth@gmail.com"; // Admin Email, admin@example.com
$config['default_group']              = 'siswa';           // Default group, use name
