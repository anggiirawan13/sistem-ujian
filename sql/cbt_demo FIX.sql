...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 27 Jul 2022 pada 16.01
...
(1, '127.0.0.1', 'Administrator', '$2y$12$tGY.AtcyXrh7WmccdbT1rOuKEcTsKH6sIUmDr0ore1yN4LnKTTtuu', 'admin@admin.com', 'default.png', NULL, '', NULL, NULL, NULL, NULL, NULL, 1658837791, 1658930392, 1, 'Admin', 'Istrator', 'ADMIN', '0');
...
ALTER TABLE `h_ujian`
  ...
  ADD KEY `h_ujian_ibfk_2` (`siswa_id`);
...
ALTER TABLE `tb_soal`
  ...
  ADD KEY `tb_soal_ibfk_1` (`mapel_id`),
  ADD KEY `tb_soal_ibfk_2` (`guru_id`);
